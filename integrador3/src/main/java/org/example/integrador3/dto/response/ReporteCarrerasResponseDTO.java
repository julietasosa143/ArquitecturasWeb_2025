...
public class ReporteCarrerasResponseDTO {
    private String nombreCarrera;
    private Integer anioInscripcion;
    private Long cantidadInscriptos;
    private Long cantidadEgresados;

    public ReporteCarrerasResponseDTO(String nombreCarrera,Integer anioInscripcion, Long cantidadInscriptos,Long cantidadEgresados ) {
